                    ...
                    <div class="row">
                        ...
                        <div>
                            <table class="table  table-striped">
                                ...
                                <tbody>
                                    <c:forEach var="proveedor" items="${data}"> 
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/ServletProveedores?accion=eliminar&id=${proveedor.id_proveedor}" role="button">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card text-center bg-primary text-white mb-3">
                                    <div class="card-body">
                                        ...
                                        <h4 class="display-4">${totalProveedores}</h4>
                                    </div>
                                </div>
                            </div>
