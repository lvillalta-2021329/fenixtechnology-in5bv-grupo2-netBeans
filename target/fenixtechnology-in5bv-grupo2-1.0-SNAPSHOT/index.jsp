<%-- 
    ...
    Developer   : Steeven Cumez
    Developer   : Lionard Villallta 
--%>
...
<html lang="es">
    ...
    <body>
        <header>
            <h1>
                <i class="fa-brands fa-phoenix-squadron"></i> Fenix Technology
            </h1>
        </header>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-10 col-sm-8    col-md-6">
                                <p class="descripcion">
                                    Este página web fue creada para la facilitación de compras de nuestros 
                                    clintes, Fenix technology también fue se trabajo en distintas areas para 
                                    poder agregar, eliminar y editar nuevos productos y asi poder llevar un control mas organizado que ofrecemos a las 
                                    personas que visitan nuestra pagina web.
                                </p>
                                <p class="descripcion">
                                    ¡¡BIENVENIDO!!
                                </p>
